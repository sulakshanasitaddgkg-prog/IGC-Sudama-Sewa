...
export const DEPARTMENTS_TEAMS = {
  "IGF":      ["Lalita","Vishakha","Tungavidya","Indulekha","Rangadevi","Sudevi","Chitralekha","Champaklata","Other"],
  "IYF":      ["Anant","Keshav","Govind","Madhava","Janardhan","Other"],
  "ICF_Mtg":  ["Rukmani","Jamvanti","Satyabhama","Bhadra","Kalindi","Rohini","Lakshmana","Kaushla","Other"],
  "ICF_Prji": ["Vasudeva","Pradyumna","Anirudha","Sankarshan","Other"]
};
